...
$("#compania").change(function(event){
  $.get("/coordinador/insertar/incidencia/"+event.target.value+"",function(response,compania){
    $("#handling").empty();
...
$("#tipoIncidencia").change(function(event){
  $.get("/coordinador/insertar/incidencia/causante/"+event.target.value+"",function(response,tipo){
    $("#causante").empty();
    for(i=0; i<response.length; i++){
...
$("#causante").change(function(event){
  $.get("/coordinador/insertar/incidencia/tipo/"+event.target.value+"",function(response,causante){
    $("#tipoCausante").empty();
    for(i=0; i<response.length; i++){
